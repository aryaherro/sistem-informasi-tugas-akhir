        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <div class="user-panel mt-1 pb-1 mb-1 d-flex">
                    <li class="nav-item <?= (strstr(current_url(), base_url("/prodi/TugasAkhir"))) ? "menu-is-opening menu-open" : ""; ?>">

                        <a href="#" class="nav-link <?= (strstr(current_url(), base_url("/prodi/TugasAkhir"))) ? "active" : ""; ?>">
                            <p>
                                Validasi
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= route_to("prodi.judul"); ?>" class="nav-link <?= (current_url() == base_url("/prodi/TugasAkhir/judul")) ? "active" : ""; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Judul Tugas Akhir</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= route_to("prodi.bimbinganProposal"); ?>" class="nav-link <?= (current_url() == base_url("/prodi/TugasAkhir/proposal")) ? "active" : ""; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Data Proposal Tugas Akhir Mahasiswa</p>
                                </a>
                            </li>
                            <a href="<?= route_to("prodi.bimbinganTugasAkhir"); ?>" class="nav-link <?= (current_url() == base_url("/prodi/TugasAkhir/TA")) ? "active" : ""; ?>">
                                <a href="../../index2.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
