...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                    <h1>Data Uji Tugas Akhir Mahasiswa</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($berita_acara == null) :; ?>
                                <div>Tidak ada mahasiswa yang melakukan Ujian Seminar Tugas Akhir</div>
                            <?php else : ?>
                                                    ...
                                                    <center>
                                                        <?php if ($key['dosuji1_id'] == $person['id']) : ?>
                                                            <?php if ($key['Berkas_saran_dosuji1'] == null) : ?>
                                                                <a data-toggle="modal" data-nim="<?= $key['nim']; ?>" data-nama="<?= $key['nama']; ?>" data-judul="<?= $key['judul']; ?>" data-jad=<?= $key['jadwalSeminarTugasAkhir_id']; ?> title="Add this item" class="open-AddUji btn btn-info" href="#AddUji">Upload</a>
                                                            <?php else : ?>
                                                                <a class="btn btn-info" href="<?= base_url("Dosen/UjiSeminar/Download/{$key['mahasiswa_id']}/{$key['judulTugasAkhir_id']}/T/1"); ?>">Download</a>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= route_to('TugasAkhir') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
