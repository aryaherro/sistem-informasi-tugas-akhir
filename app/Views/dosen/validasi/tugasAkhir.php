...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col">
                    <h1>Data Bimbingan Tugas Akhir Mahasiswa</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                                        ...
                                        <?php foreach ($judul as $key) :; ?>
                                            ...
                                            <?php foreach ($bimbingan[$key['id']] as $keyB) :; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a class="btn btn-info" href="<?= base_url("Dosen/TugasAkhir/downloadBimbingan/{$key['mahasiswa_id']}/{$key['id']}/T/{$keyB['id']}"); ?>">Download</a>
                                                        </center>
                                                    </td>
                                                    <td>
                                                        <center>
                                                            <?php if ($key['dospem1_id'] == $person['id']) : ?>
                                                                ...
                                                                <?php else : ?>
                                                                    <a class="btn btn-info" href="<?= base_url("Dosen/TugasAkhir/downloadBimbingan/{$key['mahasiswa_id']}/{$key['id']}/T/{$keyB['id']}/1"); ?>">Download</a>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                            <?php if ($key['dospem2_id'] == $person['id']) : ?>
                                                                <?php if ($keyB['Berkas_saran_dospem2'] == null) : ?>
                                                                    <a data-toggle="modal" data-nim="<?= $m['nim']; ?>" data-nama="<?= $m['nama']; ?>" data-judul="<?= $key['judul']; ?>" data-bimbingan="<?= $j - 1; ?>" data-bim=<?= $keyB['id']; ?> data-jud=<?= $key['id']; ?> title="Add this item" class="open-AddBimbingan btn btn-info" href="#AddBimbingan">Upload</a>
                                                                <?php else : ?>
                                                                    <a class="btn btn-info" href="<?= base_url("Dosen/TugasAkhir/downloadBimbingan/{$key['mahasiswa_id']}/{$key['id']}/T/{$keyB['id']}/2"); ?>">Download</a>
                                                                <?php endif; ?>
                                                            <?php endif; ?>
                                                        </center>
                                                    </td>
